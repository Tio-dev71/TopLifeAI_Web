const fs = require('fs');
const file = 'frontend/src/app/about/page.tsx';
         ...
         <section className="relative pt-10 pb-20 lg:pt-16 lg:pb-28 overflow-hidden bg-gradient-to-r from-[#F0F7F9] to-transparent">
            <div className="max-w-[1536px] w-full mx-auto px-6 lg:px-12 relative z-10">
               ...
               <div className="flex flex-col lg:flex-row items-center gap-12">
                  ...
                  <div className="lg:w-1/2 absolute top-0 right-0 w-full h-full lg:relative z-0">
                     <div className="absolute inset-0 bg-gradient-to-r from-[#F0F7F9] via-[#F0F7F9]/80 lg:via-transparent to-transparent z-10 w-[60%] lg:w-[20%]"></div>
               ...
               <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                  ...
                  <div className="lg:w-[40%] relative">
                     <div className="relative h-full min-h-[500px] w-full rounded-[24px] overflow-hidden shadow-sm border border-slate-100">
                        <Image src="https://images.unsplash.com/photo-1576091160550-2173ff9e5ee5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Doctor smiling" fill className="object-cover" />
