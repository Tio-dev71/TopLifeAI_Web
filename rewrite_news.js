const fs = require('fs');
const file = 'frontend/src/app/news/page.tsx';
...
export default function NewsPage() {
   ...
   return (
      <div className="flex flex-col min-h-screen bg-[#F8FBFC]">
         {/* Hero Section */}
         <section className="relative pt-10 pb-32 overflow-hidden bg-gradient-to-r from-[#F0F7F9] to-[#E3F2F3] lg:to-transparent">
